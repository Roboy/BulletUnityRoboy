...
public abstract class SenseGlove_HandModel : MonoBehaviour
{
    ...
    public List<List<Transform>> fingerJoints = new List<List<Transform>>();

    /// <summary> The initial angles of the hand model, corresponding to (0, 0, 0) rotation of the fingers. </summary>
    public List<List<Quaternion>> fingerCorrection = new List<List<Quaternion>>();
    ...
    public abstract void CollectFingerJoints(); 
